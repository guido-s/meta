...
#' homogeneous treatment estimates, the Hartung-Knapp variance
#' estimate can be arbitrarily small resulting in a very narrow
#' confidence interval (Knapp and Hartung, 2003; Wiksten et al.,
#' 2016). In such cases, an \emph{ad hoc} variance correction has been
#' proposed (Knapp and Hartung, 2003) which is used if argument
#' \code{adhoc.hakn = TRUE}.
#' }
#' 

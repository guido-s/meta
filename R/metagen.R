...
#' hazard ratios) and their standard errors; inverse variance
...
#' pooling of survival data (using log hazard ratio and standard
#' errors as input). The inverse variance method is used for pooling.
#' 

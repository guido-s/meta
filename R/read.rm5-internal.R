...
oct2txt <- function(txt) {
  ...
  txt <- gsub("\240", " ", txt)
  txt <- gsub("\241", "!", txt)
  txt <- gsub("\242", "cent", txt)
  txt <- gsub("\243", "Pound", txt)
  txt <- gsub("\244", "C", txt)
  txt <- gsub("\245", "Yen", txt)
  txt <- gsub("\246", "|", txt)
  txt <- gsub("\247", "S", txt)
  txt <- gsub("\250", "", txt)
  txt <- gsub("\251", "(C)", txt)
  ...
  txt <- gsub("\272", "o", txt)
  txt <- gsub("\273", '"', txt)
  txt <- gsub("\274", "1/4", txt)
  txt <- gsub("\275", "1/2", txt)
  txt <- gsub("\276", "3/4", txt)
  txt <- gsub("\277", "?", txt)
  txt <- gsub("\300", "A", txt)
  txt <- gsub("\301", "A", txt)
  txt <- gsub("\302", "A", txt)
